...
type AWSControlPlaneAdmissionHook struct {
	client *kubernetes.Clientset // Kubernetes client for calling Api
}

func (ah *AWSControlPlaneAdmissionHook) ValidatingResource() (plural schema.GroupVersionResource, singular string) {
	return schema.GroupVersionResource{
			Group:    "infrastructure.giantswarm.io",
			Version:  "v1alpha2",
			Resource: "awscontrolplane",
		},
		"AdmissionReview"
}

func (ah *AWSControlPlaneAdmissionHook) Admit(req *admissionv1beta1.AdmissionRequest) *admissionv1beta1.AdmissionResponse {
...
func (ah *AWSControlPlaneAdmissionHook) Initialize(kubeClientConfig *rest.Config, stopCh <-chan struct{}) error {
